...
class Instrument(BaseEntity):
    ...
    def from_dict(data, ctx):
        ...
        if data.get("minimumTradeSize") is not None:
            data["minimumTradeSize"] = ctx.convert_decimal_number(data.get("minimumTradeSize"))
        ...
        if data.get("maximumOrderUnits") is not None:
            data["maximumOrderUnits"] = ctx.convert_decimal_number(data.get("maximumOrderUnits"))
        ...
        if data.get("commission") is not None:
            data["commission"] = ctx.primitives.InstrumentCommission.from_dict(
                data["commission"], ctx
            )
...
class InstrumentCommission(BaseEntity):
    ...
    def from_dict(data, ctx):
        ...
        if data.get("minimumCommission") is not None:
            data["minimumCommission"] = ctx.convert_decimal_number(data.get("minimumCommission"))
...
class GuaranteedStopLossOrderLevelRestriction(BaseEntity):
    ...
    def from_dict(data, ctx):
        ...
        if data.get("volume") is not None:
            data["volume"] = ctx.convert_decimal_number(data.get("volume"))

        if data.get("priceRange") is not None:
            data["priceRange"] = ctx.convert_decimal_number(data.get("priceRange"))
