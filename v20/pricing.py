...
class ClientPrice(BaseEntity):
    ...
    def from_dict(data, ctx):
        ...
        if data.get("closeoutBid") is not None:
            data["closeoutBid"] = ctx.convert_decimal_number(data.get("closeoutBid"))
...
class HomeConversions(BaseEntity):
    ...
    def from_dict(data, ctx):
        ...
        if data.get("accountGain") is not None:
            data["accountGain"] = ctx.convert_decimal_number(data.get("accountGain"))
...
class EntitySpec(object):
    ...
    def get_price_range(self, instrument, **kwargs):
        ...
        request = Request("GET", "/v3/pricing/range")
    ...
    def candles(self, instrument, **kwargs):
        ...
        request.set_path_param("accountID", kwargs.get("accountID"))
        ...
        request.set_param("units", kwargs.get("units"))
