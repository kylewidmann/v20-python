...
class OrderClientExtensionsModifyTransaction(BaseEntity):
    ...
    def from_dict(data, ctx):
        ...
        if data.get("clientExtensionsModify") is not None:
            data["clientExtensionsModify"] = ctx.transaction.ClientExtensions.from_dict(
...
class EntitySpec(object):
    ...
    def list(self, accountID, **kwargs):
        ...
        request = Request("GET", "/v3/accounts/{accountID}/transactions")
    ...
    def get(self, accountID, transactionID, **kwargs):
        """
        ...
        if str(response.status) == "200":
            if jbody.get("transaction") is not None:
                parsed_body["transaction"] = self.ctx.transaction.Transaction.from_dict(
                    jbody["transaction"], self.ctx
                )
    ...
    def range(self, accountID, **kwargs):
        """
        ...
        request = Request("GET", "/v3/accounts/{accountID}/transactions/idrange")

        request.set_path_param("accountID", accountID)

        request.set_param("from", kwargs.get("fromID"))

        request.set_param("to", kwargs.get("toID"))
    ...
    def since(self, accountID, **kwargs):
        """
        ...
        request = Request("GET", "/v3/accounts/{accountID}/transactions/sinceid")

        request.set_path_param("accountID", accountID)

        request.set_param("id", kwargs.get("id"))
