...
from v20.base_entity import BaseEntity, EntityDict
...
class Order(BaseEntity):
    ...
    def from_dict(data, ctx):
        ...
        if data.get("clientExtensions") is not None:
            data["clientExtensions"] = ctx.transaction.ClientExtensions.from_dict(
...
class MarketOrder(BaseEntity):
    ...
    def from_dict(data, ctx):
        ...
        if data.get("units") is not None:
            data["units"] = ctx.convert_decimal_number(data.get("units"))
        ...
        if data.get("tradeClose") is not None:
            data["tradeClose"] = ctx.transaction.MarketOrderTradeClose.from_dict(
                data["tradeClose"], ctx
            )
        ...
        if data.get("stopLossOnFill") is not None:
            data["stopLossOnFill"] = ctx.transaction.StopLossDetails.from_dict(
        ...
        if data.get("tradeClientExtensions") is not None:
            data["tradeClientExtensions"] = ctx.transaction.ClientExtensions.from_dict(
...
class UnitsAvailableDetails(BaseEntity):
    ...
    def from_dict(data, ctx):
        ...
        if data.get("long") is not None:
            data["long"] = ctx.convert_decimal_number(data.get("long"))

        if data.get("short") is not None:
            data["short"] = ctx.convert_decimal_number(data.get("short"))
...
class EntitySpec(object):
    ...
    def create(self, accountID, **kwargs):
        ...
        request = Request("POST", "/v3/accounts/{accountID}/orders")
        ...
        if str(response.status) == "201":
            ...
            if jbody.get("orderFillTransaction") is not None:
                parsed_body["orderFillTransaction"] = (
                    self.ctx.transaction.OrderFillTransaction.from_dict(
                        jbody["orderFillTransaction"], self.ctx
                    )
                )
            ...
            if jbody.get("orderCancelTransaction") is not None:
                parsed_body["orderCancelTransaction"] = (
                    self.ctx.transaction.OrderCancelTransaction.from_dict(
                        jbody["orderCancelTransaction"], self.ctx
                    )
                )
            ...
            if jbody.get("orderReissueRejectTransaction") is not None:
                parsed_body["orderReissueRejectTransaction"] = (
                    self.ctx.transaction.Transaction.from_dict(
                        jbody["orderReissueRejectTransaction"], self.ctx
                    )
                )
    ...
    def list_pending(self, accountID, **kwargs):
        """
        ...
        request = Request("GET", "/v3/accounts/{accountID}/pendingOrders")
    ...
    def get(self, accountID, orderSpecifier, **kwargs):
        """
        ...
        request = Request("GET", "/v3/accounts/{accountID}/orders/{orderSpecifier}")
    ...
    def replace(self, accountID, orderSpecifier, **kwargs):
        """
        ...
        if str(response.status) == "201":
            ...
            if jbody.get("replacingOrderCancelTransaction") is not None:
                parsed_body["replacingOrderCancelTransaction"] = (
                    self.ctx.transaction.OrderCancelTransaction.from_dict(
                        jbody["replacingOrderCancelTransaction"], self.ctx
                    )
                )
            ...
            if jbody.get("orderCancelRejectTransaction") is not None:
                parsed_body["orderCancelRejectTransaction"] = (
                    self.ctx.transaction.Transaction.from_dict(
                        jbody["orderCancelRejectTransaction"], self.ctx
                    )
                )
    ...
    def set_client_extensions(self, accountID, orderSpecifier, **kwargs):
        """
            ...
            if jbody.get("orderClientExtensionsModifyTransaction") is not None:
                parsed_body["orderClientExtensionsModifyTransaction"] = (
                    self.ctx.transaction.OrderClientExtensionsModifyTransaction.from_dict(
                        jbody["orderClientExtensionsModifyTransaction"], self.ctx
                    )
                )
            ...
            if jbody.get("orderClientExtensionsModifyRejectTransaction") is not None:
                parsed_body["orderClientExtensionsModifyRejectTransaction"] = (
                    self.ctx.transaction.OrderClientExtensionsModifyRejectTransaction.from_dict(
                        jbody["orderClientExtensionsModifyRejectTransaction"], self.ctx
                    )
                )
    ...
    def market(self, accountID, **kwargs):
        ...
        Returns:
            ...
            the request
        """
        return self.create(accountID, order=MarketOrderRequest(**kwargs))
    ...
    def limit(self, accountID, **kwargs):
        ...
        Returns:
            ...
            the request
        """
        return self.create(accountID, order=LimitOrderRequest(**kwargs))
    ...
    def take_profit_replace(self, accountID, orderID, **kwargs):
        ...
        Returns:
            ...
            the request
        """
        return self.replace(accountID, orderID, order=TakeProfitOrderRequest(**kwargs))
